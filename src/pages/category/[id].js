...
const CategoryPage = () => {
  ...
  return (
    <div>
      <GlobalLayout />
      <div className=' px-10 bg-nav-background h-full flex flex-col'>
        <div className='flex flex-row py-12 w-full  '>
          ...
          <div className='flex flex-row ml-12' style={{ width: "70%", gap: "30px", flexWrap: "wrap" }} id={"content"}>
            ...
            >
              {product !== undefined && product.map((e) => {
                return (
                  ...
                  >
                    <ProductCard
                      src={e.product_image !== null && e.product_image.images[0] !== null ? `${e.product_image.images[0]}` : "/bundle-1.svg"}
                      data={e}
                    />
                  </div>
                )
