...
const BottomFooter = () => {
	...
	return (
		<div className="flex flex-row px-16 border-t-1 border-black  py-8 bg-green2 justify-between z-50  w-full">
			...
			<div className="flex flex-col" style={{ width: "30%" }}>
				...
				<div
					...
					<Image className="m-1" src={"/icons/location.svg"} width={20} height={20} />
				...
				<div className="flex flex-row items-center mt-2">
					<Image className="m-1" src={"/icons/call.svg"} width={18} height={18} />
					<p className="text-sm ml-2">Утас: 72720808</p>
				</div>
				<div className="flex flex-row items-start mt-1">
					<Image className="m-1" src={"/icons/mail.svg"} width={20} height={20} />
					<p className="text-sm ml-2">И-мэйл хаяг: tarimalurgamal2016@gmail.com</p>
				</div>
			</div>
		</div>
	);
